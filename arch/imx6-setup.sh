#!
# wget -O - https://raw.githubusercontent.com/chrnnk/linux/main/scripts/1-users-apps.sh | bash
...
# setup hostname
sudo hostnamectl set-hostname potato02
sudo nano /etc/hosts
...
sudo apt install neofetch ncdu git -y
