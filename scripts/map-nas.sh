#!
# wget -O - https://raw.githubusercontent.com/chrnnk/linux/main/scripts/2-map-nas.sh | bash
...
sudo su -c "echo 'xerxes-unraid.home.chrnnk.tv:/mnt/user/data/     /mnt/media    nfs default 0 0' >> /etc/fstab"
sudo mount -a
